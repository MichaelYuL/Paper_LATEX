...
\begin{document}
\title{	Robust Dynamic Latent Variable Model for Dynamic Process monitoring with Missing Data in Cyber-Physical Systems}

\author{
	\vskip 1em
	
	Le Zhou, \emph{Student Membership},
	Lixinqian Yu, \emph{Membership}, Beiping Hou, Hongbo Zheng
	\\ and Zheng-Guang Wu, \emph{Membership}
	...
	\thanks{
		...
		Lixinqian Yu are with the University of Melbourne, Victoria, 3010, Australia, email: lixinqianyu@student.student.unimelb.au.
...
%\vspace{-1cm}
\begin{IEEEbiography}[{\includegraphics[width=1in,height=1.25in,clip,keepaspectratio]{ylxq.JPG}}]
